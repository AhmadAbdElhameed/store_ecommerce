                        ...
                        @foreach ($pcategories as $pcategorie)
                            <div class="card-1">
                                <figure class=" img-hover-scale overflow-hidden">
                                    <a href="{{route('product.category',['slug' => $pcategorie->slug])}}"><img src="{{asset ('assets/imgs/categories')}}/{{$pcategorie->image}}" alt=""></a>
                                </figure>
                                <h5><a href="{{route('product.category',['slug' => $pcategorie->slug])}}">{{$pcategorie->name}}</a></h5>
                            </div>
                        @endforeach
                    </div>
                </div>
