                            ...
                            <div class="card-body">
                                ...
                                <form wire:submit.prevent="addProduct">
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <textarea name="short_description" class="form-control" placeholder="Enter Short Description" cols="30" rows="10" wire:model="short_description"></textarea>
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <textarea name="description" class="form-control" placeholder="Enter Description" cols="30" rows="10" wire:model="description"></textarea>
                                        @error('description')
                                            <p class="text-danger">{{$message}}</p>
                                        @enderror
                                    </div>
